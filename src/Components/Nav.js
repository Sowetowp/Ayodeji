    ...
    <>
        <nav className="navbar navbar-expand-sm navbackground">
            <div className="container-fluid">
                ...
                <a className='searchButton' data-bs-toggle="modal" data-bs-target="#myModal" type='button'>
                    <span className='searchsp'>search portfolio...</span>
                    <span className='searchsp2'>
                        <div className="loader">
                            <svg className='logo' width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className='spanfortext'>A</span>
                    </span>
                </a>
                <div class="modal" id="myModal">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title" style={{display:"flex", alignItems:"center"}}>
                                <img style={{width:"15px"}} src={search}/>
                                <input className='modalInp' placeholder='Type anything...'/>
                            </h4>
