    ...
    <>
        <div className='container-fluid p-0 aboutme mw'>
            ...
            <div className='workType'>
              <button style={{backgroundColor: `${hcolor && bg === "all" ? hcolor : hcolor2}`}} className='drewo' onClick={() => filterer2()}><span style={{color: `${bg === "all" ? "black" : hcolor}`}}>ALL</span></button>
              <button style={{backgroundColor: `${hcolor && bg === "html" ? hcolor : hcolor2}`}} className='drewo' onClick={() => filterer("html")}><span style={{color: `${bg === "html" ? "black" : hcolor}`}}>HTML/CSS</span></button>
              <button style={{backgroundColor: `${hcolor && bg === "react" ? hcolor : hcolor2}`}} className='drewo' onClick={() => filterer("react")}><span style={{color: `${bg === "react" ? "black" : hcolor}`}}>REACT JS</span></button>
              <button style={{backgroundColor: `${hcolor && bg === "flask" ? hcolor : hcolor2}`}} className='drewo' onClick={() => filterer("flask")}><span style={{color: `${bg === "flask" ? "black" : hcolor}`}}>FLASK</span></button>
              <button style={{backgroundColor: `${hcolor && bg === "node" ? hcolor : hcolor2}`}} className='drewo' onClick={() => filterer("node")}><span style={{color: `${bg === "node" ? "black" : hcolor}`}}>NODE JS</span></button>
              <button style={{backgroundColor: `${hcolor && bg === "native" ? hcolor : hcolor2}`}} className='drewo' onClick={() => filterer("native")}><span style={{color: `${bg === "native" ? "black" : hcolor}`}}>REACT NATIVE</span></button>
            </div>
                ...
                <div className='bgCanvas p-3'>
                  <div className='canvasImgContainer'>
                    <div className='canvasImgCover'>
                      <button class="btngit" style={{backgroundColor:`${hcolor ? hcolor : "rgba(20, 223, 166)"}`}}>
