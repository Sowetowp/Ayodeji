      ...
      <div className='container-fluid home' style={{overflow:"hidden"}}>
        ...
        <div className='inde'>
          <div data-aos="fade-up" data-aos-duration="1000" className='dphome'>
            ...
            <div style={{background: `${hcolor ? `linear-gradient(transparent, 10%, ${col1 && col1.length > 0 ? col1 : hcolor})` : "linear-gradient(transparent, 10%, rgb(20, 223, 166))"}`}} className='spin'></div>
          </div>
          ...
          <div className='small-icons mt-3' data-aos-offset="-200" data-aos="fade-up" data-aos-duration="2500">
            <StyledDiv afterColor={col1 && col1.length > 0 ? col1 : hcolor ? hcolor : "rgb(20, 223, 166)"} onMouseEnter={sub} onMouseLeave={add} className='bdre' target="_blank" href="https://github.com/Sowetowp">
            ...
            <StyledDiv afterColor={col1 && col1.length > 0 ? col1 : hcolor ? hcolor : "rgb(20, 223, 166)"} onMouseEnter={sub1} onMouseLeave={add1} target="_blank" className='bdre' href="https://www.linkedin.com/in/abdulmalik-amzat-a0647321b/">
            ...
            <StyledDiv afterColor={col1 && col1.length > 0 ? col1 : hcolor ? hcolor : "rgb(20, 223, 166)"} onMouseEnter={sub2} onMouseLeave={add2} target="_blank" className='bdre' href='https://www.threads.net/@amzat_abdulmalik'>
            ...
            <StyledDiv afterColor={col1 && col1.length > 0 ? col1 : hcolor ? hcolor : "rgb(20, 223, 166)"} onMouseEnter={sub3} onMouseLeave={add3} target="_blank" className='bdre' href='https://twitter.com/amzat_abdmalik?s=11&t=5RvOaHdVfPfpYh2LQdQnIw'>
