      ...
      <div className='container-fluid home' style={{overflow:"hidden"}}>
        ...
        <div className='inde'>
          ...
          <div className='small-icons mt-3' data-aos-offset="-200" data-aos="fade-up" data-aos-duration="2500">
            <a onMouseEnter={sub} onMouseLeave={add} className='bdre' target="_blank" href="https://github.com/Sowetowp">
            ...
            <a onMouseEnter={sub1} onMouseLeave={add1} target="_blank" className='bdre' href="https://www.linkedin.com/in/abdulmalik-amzat-a0647321b/">
            ...
            <a onMouseEnter={sub2} onMouseLeave={add2} target="_blank" className='bdre' href='https://www.threads.net/@amzat_abdulmalik'>
            ...
            <a onMouseEnter={sub3} onMouseLeave={add3} target="_blank" className='bdre' href='https://twitter.com/amzat_abdmalik?s=11&t=5RvOaHdVfPfpYh2LQdQnIw'>
